...
var PageContainer = function PageContainer(props) {
  ...
  var className = (0, _classnames.default)(prefixedClassName, props.className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-page-container-ghost"), ghost), _defineProperty(_classNames, "".concat(prefixCls, "-page-container-with-footer"), footer), _classNames));
  ...
  var pageHeaderDom = /*#__PURE__*/_react.default.createElement(ProPageHeader, _extends({}, props, {
    prefixCls: undefined,
    prefixedClassName: prefixedClassName
  }));
  ...
  }, affixProps), pageHeaderDom) : pageHeaderDom, /*#__PURE__*/_react.default.createElement(_GridContent.default, null, renderContent()), footer && /*#__PURE__*/_react.default.createElement(_FooterToolbar.default, {
    prefixCls: prefixCls
  }, footer));
};
