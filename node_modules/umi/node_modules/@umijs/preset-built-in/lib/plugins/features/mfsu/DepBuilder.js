    ...
    return _asyncToGenerator(function* () {
      ...
      for (var _i = 0, _Object$keys = Object.keys(deps); _i < _Object$keys.length; _i++) {
        ...
        try {
          ...
          (0, _fs().writeFileSync)((0, _utils().winPath)((0, _path().join)(_this2.tmpDir, normalizeDepPath(`${_constants.MF_VA_PREFIX}${dep}.js`, _this2.api.cwd))), [yield (0, _utils2.figureOutExport)(_this2.api.cwd, (0, _utils().winPath)(requireFrom)), ''].join('\n').trimLeft(), 'utf-8');
        } catch (err) {
